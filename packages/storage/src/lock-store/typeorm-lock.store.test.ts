  ...
  describe('typeorm', () => {
    ...
    describe('acquireLock', () => {
      it('acquires a lock.', async () => {
        await expect(lockStore.acquireLock({ value: 'value' })).resolves.toBe(undefined)
      })
      ...
      it('supports locks with different values.', async () => {
        await expect(lockStore.acquireLock({ value: 'value' })).resolves.toBe(undefined)
        await expect(lockStore.acquireLock({ value: 'other-value' })).resolves.toBe(undefined)
      })
    ...
    describe('releaseLock', () => {
      it('releases the lock.', async () => {
        await expect(lockStore.acquireLock({ value: 'value' })).resolves.toBe(undefined)
        await expect(lockStore.releaseLock({ value: 'value' })).resolves.toBe(undefined)
